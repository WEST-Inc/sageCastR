...
Because populations, communities, and ecosystems are not static, using the current status of an ecosystem \new{may be insufficient to define protected areas for species} (Hannah et al. 2007, Monzón et al. 2011) or to make optimal management decisions [@boettiger_optimal_2016].
...
The `focal` function from the **raster** package in R (CITE!!!) cannot accommodate missing values when calculating a focal mean with custom weights.
