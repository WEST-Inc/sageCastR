...
\textcolor{blue}{Avoiding variable selection avoids some computational constratins.}
...
\textcolor{blue}{So to could targeted modeling studies that use more climate and environmental covariates then we used here.}
