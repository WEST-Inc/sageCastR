...
\noindent{}Data and code are provided as private-for-peer review (shared publicly in a repository: https://github.com/WEST-Inc/sageCastR). Data and code will be archived on Zenodo upon acceptance. Projections generated during this study are available as a USGS data release (Tredennick et al., 2023 [citation to be added once provided by USGS]). All data used in this study are publicly available elsewhere as cited in the text.
...
\new{Projections generated during this study are available as a USGS data release (Tredennick et al. 2023).}
...
Convergence diagnostics indicated that most MCMC chains converged on their stationary distributions (upper 0.95 quantiles of $\hat{R}$ < 1.1 for all parameters; see online supporting information).
\new{This was true except for the model for Elk Basin West.}
...
\new{Results based on summer habitat cover targets are similar (online supporting information section "Summer habitat cover targets compared to projections").}
...
Continued conservation of these core areas has the potential to increase \new{the extent of the landscape with sagebrush cover exceeding the nesting and summer habitat thresholds} (Fig. \@ref(fig:nesting-targs) and online supporting information).
...
@schlaepfer_understanding_2021 found a similar result in terms of sagebrush regeneration: regeneration will likely remain possible under a warming climate alone, but the fire-cheatgrass interaction will likely limit sagebrush persistence.
